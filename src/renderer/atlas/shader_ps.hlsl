...
Texture2D<float4> colorBitmap : register(t0);
...
// clang-format on
{
    ...
    case SHADING_TYPE_TEXT_BACKGROUND:
    {
        ...
        color = all(cell < cellCount) ? colorBitmap[cell] : backgroundColor;
